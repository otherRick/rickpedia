...
const Heart = ({ onHearClick, width = 20, height = 20, isClicked }: HeartProps) => {
  return (
    <div className={`heart${isClicked ? 'clicked' : ''}`} onClick={() => {}}>
      <svg onClick={onHearClick} width={width} height={height} viewBox='0 0 32 32'>
        <path
          fill={isClicked ? '#fb6467ff' : 'transparent'}
